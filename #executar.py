...
# Transformações com aumento de dados simples para treino e só normalização para validação
...
# Dataset completo com transform de treino temporário (vai ser ajustado no split)
...
# Ajustando transform da validação para não usar aumento de dados
...
# Número de classes (raças de cachorro)
...
# Função de treino com validação
...
# Executa treinamento
treinar_modelo(model, train_loader, val_loader, num_epochs=3)
